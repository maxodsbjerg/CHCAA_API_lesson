...
So now we managed to get the production start and end out of the nested JSON format. Next we will use the function `glimpse()` to create a summary of the "flourishing_artworks_df"-dataframe:
